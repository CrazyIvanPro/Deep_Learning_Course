...
def get_dataset_batch(ds_name, noise_level):
...
def main():
    ...
    boundaries = [train_set.minibatchs_per_epoch*5, train_set.minibatchs_per_epoch*40, train_set.minibatchs_per_epoch*100]
    values = [0.0001, 0.0001, 0.00005, 0.00001]
